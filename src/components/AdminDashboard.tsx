...
import { LayoutDashboard, Users, DollarSign, Trash2, Calendar, FileText, LogOut, Menu, X, User } from 'lucide-react';
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                <h2>Admin RT</h2>
                <p className="text-sm text-gray-600">Panel Kontrol</p>
              </div>
              <Button
                variant="ghost"
                size="sm"
          ...
          <div className="p-4 border-b border-gray-200">
            ...
            >
              ...
              <div className="text-left flex-1">
                <p className="text-sm">Admin RT</p>
                <p className="text-xs text-gray-600">Ketua RT 003</p>
              </div>
            </button>
          </div>
